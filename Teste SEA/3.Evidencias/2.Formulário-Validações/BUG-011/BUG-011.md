...
## Impacto
- Gera confusão no preenchimento e quebra a regra condicional do formulário, exibição incorreta do bloco de atestado.
- Afeta padronização e conformidade com o protótipo, layout do checkbox.

## Evidências
**Aplicação (Atual):**  
![Aplicação - Checkbox e bloco de atestado](aplicacao_BUG-011.png)

**Protótipo (Esperado):**  
![Protótipo - Checkbox e bloco de atestado](prototipo_BUG-011.png)
