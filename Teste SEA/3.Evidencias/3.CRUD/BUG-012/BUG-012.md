...
## Impacto
- Impede o usuário de editar e excluir registros de funcionários pelo fluxo esperado.
- Bloqueia a validação do requisito do desafio referente ao menu de opções **(...)** com **Alterar/Excluir**.
- Pode gerar retrabalho e inconsistência de dados, já que o usuário não consegue corrigir cadastros ou remover registros incorretos.

## Evidências

**Aplicação (Atual):**  
![Aplicação - Menu/Opções divergentes](aplicacao_BUG-012.png)

**Protótipo (Esperado):**  
![Protótipo - Menu Alterar/Excluir](prototipo_BUG-012.png)
